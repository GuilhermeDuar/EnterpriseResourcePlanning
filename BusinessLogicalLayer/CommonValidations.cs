...
namespace BusinessLogicalLayer
{
    internal class CommonValidations
    {
        ...
        public static string IsValidCidadeUF(string uf, string cidade)
        {
            ...
            string[] uFs = { "PR", "RS", "SC", "SP", };
            if (!uFs.Contains(uf))
            {
                return "UF inválida.\r\n";
            }

            string[] cidadesValidasSP = { "São Paulo", "Santos", "Bauru" };
            string[] cidadesValidasSC = { "Blumenau", "Joaçaba", "Luiz Alves" };
            string[] cidadesValidasPR = { "Curitiba", "Londrina", "Ponta Grossa" };
            string[] cidadesValidasRS = { "Porto Algre", "Não Me Toque", "Vacaria", };
        ...
        //}
        //return IsValidLength(cidade, 3, 30, "Cidade");
        //}

        //public static string IsValidUF(string uf)
        //{
        //    if (string.IsNullOrWhiteSpace(uf))
        //    {
        //        return "UF deve ser selecionada.\r\n";
        //    }
        ...
        public static string IsValidTelefoneCelular(string telefone)
        {
        ...
        public static string IsValidEstadoCivil(string estadoCivil)
        {
            ...
            string[] estadosCivis = {"Solteiro", "Casado", "Viúvo", "Divorciado", "Separado"};
        ...
        public static string IsValidAge(DateTime dataDeNascimento)
        {
            DateTime birthdate = dataDeNascimento;
